...
SQL;
    ...
    private function getPagesTitleCouplesByPatternQuery(): string
    {
        return <<< SQL
...
SQL;
    ...
    public function getPagesTitleCouplesByPattern(?string $pattern): array
    {
        ...
        $sql = $this->getPagesTitleCouplesByPatternQuery();
        $statement = $this->connection->prepare($sql);
        $statement->execute([
            "pattern" => "%$pattern%"
        ]);
